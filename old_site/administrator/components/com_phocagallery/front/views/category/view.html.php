...
class PhocaGalleryViewCategory extends JView
{
	function display($tpl = null) {
		...
		$tmpl['lm'] = '<div style="tex'.'t-align: center; color:#d3d3'.'d3;">'.'<a href="htt'.'p://pho'.'cagallery.ru" style="text-decor'.'ation: none;" tar'.'get="_bl'.'ank" title="Ph'.'oca.cz">Phoc'.'aGallery</a></div>';
		...
		$tmpl['m']							= PhocaGalleryRenderFront::getDivs();
		// PARAMS - Upload
