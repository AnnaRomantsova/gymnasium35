...
<link rel="stylesheet" href="<?php echo $this->template ?>/css/editor.css" type="text/css" />
<link href="templates/jaolyra/css/template_css.css" rel="stylesheet" type="text/css" />

<?php if ($ja_iconmenu) { ?>
<link href="templates/jaolyra/ja_iconmenu/ja-iconmenu.css" rel="stylesheet" type="text/css" />
<?php } ?>

<script language="javascript" type="text/javascript" src="<?php echo $this->template ?>/scripts/ja.script.js"></script>
...
<link href="templates/<?php echo $this->template ?>/css/colors/green.css" rel="stylesheet" type="text/css" />
