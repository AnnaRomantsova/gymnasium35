                ...
                if ( $this->getParam('level')==0) {
                        ...
                        if ( ( $menu_image <> '-1' ) && $menu_image ) {
                                ...
                                if( !isset($_SERVER['HTTP_USER_AGENT']) ||
                                        ...
                                        $txt = '<img src="'. JURI::base() .'/images/stories/'. $menu_image .'" border="0" hspace="0" vspace="0" alt="'. $row->title .'"'.$clsactive.' style="width: '.$this->getParam('icon_small').'px; height: '.$this->getParam('icon_small').'px;" />';

                                } else {
                                        $txt = '<img src="images/blank.png" border="0" hspace="0" vspace="0" alt="'. $row->title .'"'.$clsactive.' style="width: '.$this->getParam('icon_small').'px; height: '.$this->getParam('icon_small').'px; filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'images/stories/'. $menu_image .'\', sizingMethod=scale);" />';

                                }
                        } else {
                                $txt .= '<img src="'. JURI::base() .'images/blank.png" border="0" alt="'. $row->title .'" width=\'1\' height=\'1\' />';
                        }
                }
