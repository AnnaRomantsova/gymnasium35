...
if (!defined ('_JA_TRANS_MENU_CLASS')) {
	...
	class JA_Transmenu extends JA_Base{
		...
		function genMenuHead () {
			?>
			<link href="<?php echo $this->params->get('menupath'); ?>/ja_transmenu/ja.transmenuh.css" rel="stylesheet" type="text/css" />
			<script src="<?php echo $this->params->get('menupath'); ?>/ja_transmenu/ja.transmenu.js" language="javascript" type="text/javascript" ></script>
			<?php
		}
	}
}
